const CACHE='wam-instructor-lab-v2.0.0';
const ASSETS=['./','./index.html','./styles.css','./app.js','./course-data.js','./reference-data.js','./mastery-data.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
